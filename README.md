...
<head>
    ...
    <title>Host your static website with S3 bucket </title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        body {
            background: linear-gradient(135deg, #f8fafc 0%, #5899ed 100%);
            color: #2d3748;
            min-height: 100vh;
            display: flex;
            align-items: center;
...
<body>
    <div class="container">
        <div class="card">
            ...
            <div class="footer">
                <p>Start your DevOps journey today and become an expert</p>
            </div>
        </div>
    </div>
</body>
